...
# Figure 2: var vs difference between estimate and mean of simulations for mcmc and k
...
save_plot("FigureS1.pdf", FS1, base_height = 10, base_width = 15)
...
save_plot("FigureS2.pdf", FS2, base_height = 10, base_width = 15)
...
ggplot(mon_rare_res, aes(x = pop, y = Ns)) +
  geom_boxplot() +
  geom_point(alpha = .2, position = position_jitter(height = 0, width = .2)) +
  geom_point(data = seg_res_mon$weighted.means, aes(x = subfacet, y = seg_sites), color = "red") +
  theme_bw() +
  ylab(bquote(italic(N[s]))) +
  xlab("Population")
