...
# Figure 2: var vs difference between estimate and mean of simulations for mcmc and k; Figure S1
...
save_plot("FigureS1.pdf", FS1, base_height = 15, base_width = 15)
save_plot("FigureS1.jpg", FS1, base_height = 15, base_width = 15)
...
FS2 <- ggplot(ns_all_agg, aes(x = K, y = ENs - nseg, color = pop)) +
  geom_point() +
...
save_plot("FigureS2.pdf", FS2, base_height = 10, base_width = 21)
save_plot("FigureS2.jpg", FS2, base_height = 10, base_width = 21)
...
FS3 <- ggplot(mon_rare_res, aes(x = pop, y = Ns)) +
  geom_boxplot() +
...
save_plot("FigureS3.pdf", FS3, base_width = 15, base_height = 11)
save_plot("FigureS3.jpg", FS3, base_width = 15, base_height = 11)
```
