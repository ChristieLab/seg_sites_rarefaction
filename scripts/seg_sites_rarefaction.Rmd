...
```{r}
res_files <- list.files("../data/seg_sites/", "\\.RDS", full.names = TRUE)
...
```{r Figure1}
prep_f1 <- function(pseg1, pseg2, mpseg1, mpseg2){
...
```{r}
prep_f2 <- function(seg1, seg2, vseg1, vseg2, F1data){
  seg <- F1data
